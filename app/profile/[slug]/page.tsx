...
/** Sema yoksa basina https:// ekler ki link dogru acilsin */
function normalizeUrl(url: string) {
  if (/^https?:\/\//i.test(url)) return url;
  return `https://${url}`;
}

// Linkten alan adi cikar: https://www.ribankgayrimenkul.com/x -> ribankgayrimenkul.com
...
export default function ProfilePage() {
  ...
  // Gercek sosyal aglar (WhatsApp bir iletisim kanali, burada degil)
  const socials = [
    {
  ...
  // Hizli iletisim aksiyonlari - kartin asil amaci
  const quickActions = [
    profile.phone
      ...
      >
        ...
        <motion.div variants={cardVariants} className="neon-border">
          <div className="relative rounded-[1.75rem] overflow-hidden glass">
            {/* Ust toolbar: Paylas / QR / (sahibe) Duzenle */}
            ...
            {/* Birincil aksiyon: Rehbere Kaydet */}
            ...
            {/* Hizli iletisim: Ara / WhatsApp / E-posta */}
